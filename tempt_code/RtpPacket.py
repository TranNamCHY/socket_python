...
class RtpPacket:
	...
	#HEADER_SIZE = 12
        ...
        def encode(self, version, padding, extension, cc, seqnum, marker, pt, ssrc, payload,subseq,endmark):
                timestamp = int(time())  # lay gia tri thoi gian hien tai dung cho truong timestampt
                ...
                self.header[12] = subseq
                self.header[13] = endmark
